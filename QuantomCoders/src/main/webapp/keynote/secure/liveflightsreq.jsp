	...
	<div class="container">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-6 col-md-9">
			    <div class="alert alert-warning">Emirates : Live Flights</div>
				<form class="form-horizontal" role="form" action="<%=resPath%>/secure/action" method="post">
				<input type="hidden" value="<%=Constants.LIVE_FLIGHTS%>" name="action"/>

					<div class="form-group">
						<div class="col-sm-10">
							<input type="text" class="form-control" id="flightAction" placeholder="action" name="flightAction"
								value="firstTime">
						</div>
					</div>
					...
					<div class="form-group">
						<div class="col-sm-10">
							<input type="text" class="form-control" id="lastUploadedTime" 	placeholder="lastUploadedTime" 
							 name="lastUploadedTime" value="">
						</div>
					</div>
