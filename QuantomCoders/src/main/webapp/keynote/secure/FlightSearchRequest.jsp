	...
	<div class="container">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-6 col-md-9">
			    <div class="alert alert-warning">Emirates : Flight Search</div>
				<form class="form-horizontal" role="form" action="<%=resPath%>/secure/action" method="post">
				<input type="hidden" value="<%=Constants.FLIGHT_SEARCH%>" name="action"/>

		<div class="form-group">			
		<div class="col-sm-offset-0 col-sm-10">			
		<div class="btn-group" data-toggle="buttons">
		  <label class="btn btn-sm btn-default">
		    <input type="radio" name="searchOrigin" id="return" value="return" /> Return
		  </label>
		  <label class="btn btn-sm btn-default active">
		    <input type="radio" name="searchOrigin" id="oneWay" checked value="oneway"> One Way
		  </label>
		 </div>
		</div>
					...
					<div class="form-group">
					<div class="col-sm-10 col-md-2">Audults
						</div>
						<div class="col-sm-10 col-md-2">
					...
					<div class="col-sm-10 col-md-2">Childrens
						</div>
						<div class="col-sm-10 col-md-2">
		  ...
		  <label class="btn btn-sm btn-default">
		    <input type="radio" name="scheduleType" id="option3" value="1"> Shcedule
		  </label>
		</div>
