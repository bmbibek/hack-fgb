	...
	<div class="container">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-6 col-md-9">
			    <div class="alert alert-warning">Emirates : Branded Power Flight Search</div>
				<form class="form-horizontal" role="form" action="<%=resPath%>/secure/action" method="post">
				<input type="hidden" value="<%=Constants.BRANDED_POWER_FLIGHT_SEARCH%>" name="action"/>
		...
		<div class="btn-group" data-toggle="buttons">
		  ...
		  <label class="btn btn-sm btn-default active">
		    <input type="radio" name="searchOrigin" id="oneWay" checked value="ON"> One Way
					...
					<div class="form-group">
						<div class="col-sm-10 col-md-2">Search Type</div>
						<div class="col-sm-10 col-md-2">
