		...
		<div class="row">
			<div class="col-xs-12 col-sm-6 col-md-9">
				...
				<form class="form-horizontal" role="form" action="<%=resPath%>/secure/action" method="post">
					<input type="hidden" value="<%=Constants.FLIGHT_STATUS%>" name="action"/>

					<div class="form-group">						
						<div class="col-sm-10 col-md-2">
							<input type="text" class="form-control" id="" placeholder="FlightNumber" name="flightNumber"
								value="512" />
						</div>
				   </div>
				   <div class="form-group">
						<div class="col-sm-10 col-md-3">
							<input type="text" class="form-control" id="" placeholder="Date" name="date" value="<%=todaysDate%>" />
						</div>
				  </div>
					<div class="form-group">	
							<div class="col-sm-10 col-md-3">
							<input type="text" class="form-control" id="" placeholder="fltMovement" name="fltMovement" value="Departure" />
						</div>
					</div>

					<div class="form-group">						
						<div class="col-sm-10 col-md-2">
							<input type="text" class="form-control" id="" placeholder="From City" name="fromCity" value="DXB" />
						</div>
					</div>    
					    <div class="form-group">						    					
							<div class="col-sm-10 col-md-2">
								<input type="text" class="form-control" id="" placeholder="To City" name="toCity" value="DEL" />
								</div>
						</div>		
